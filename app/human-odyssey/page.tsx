...
export default function HumanOdyssey(){
 ...
 return <main className="atlas odyssey">
  ...
  <header className="topbar"><a className="brand" href="/" aria-label="AEON home"><Orbit size={30}/><span>AEON</span></a><span className="brand-note">A LIVING HISTORY<br/>OF EARTH</span><nav aria-label="Main navigation"><a href="/">Explore Earth</a><a href="/human-odyssey" className="active" aria-current="page">Human Odyssey</a></nav><a className="odyssey-back" href="/"><ArrowLeft size={15}/><span>Planet explorer</span></a></header>
